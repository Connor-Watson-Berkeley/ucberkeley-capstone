...
while true; do
    ...
    echo "Coffee PID 14800: $coffee_running process(es)"
    echo "Sugar PID 14812: $sugar_running process(es)"
    
    # Check database counts (Python will handle its own timeout internally)
    python3 << 'PYEOF'
