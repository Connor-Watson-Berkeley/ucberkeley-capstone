"""
DARTS N-HiTS Experiment

N-HiTS (Neural Hierarchical Interpolation for Time Series) is an efficient
deep learning architecture that uses hierarchical interpolation for forecasting.
"""
...
def load_data_from_local(commodity='Coffee', region=None, lookback_days=730):
...
def run_nhits_experiment(
    ...
    """Run N-HiTS model experiment."""
    print("=" * 80)
    print("DARTS N-HiTS Experiment")
    print("=" * 80)
...
if __name__ == '__main__':
    print("\n" + "=" * 80)
    print("Running N-HiTS Experiment")
    print("=" * 80 + "\n")
    ...
    print(f"Final validation RMSE: ${results['metrics']['rmse']:.4f}")
    print(f"Final validation MAE: ${results['metrics']['mae']:.4f}")
    print("=" * 80)
